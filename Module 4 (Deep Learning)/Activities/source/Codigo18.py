...
optimizer= tf.keras.optimizers.SGD(learning_rate= 0.001) # Algoritmo de aprendizaje
...
SYNC_STEPS= 500 # Sincronizamos cada 500 pasos en el entorno


### POLÍTICA E-GREEDY
eps0= 0.2 # Valor epsilon inicial
epsf= 0.01 # Valor epsilon final
epsEpisodes= 2500 # Número de episodios a generar para decaer de eps0 a epsf
...
## ALGORITMO DQN
MaxEpisodes= 20 # Número de episodios a ejecutar
...
while ep < MaxEpisodes: # Bucle principal
    ...
    DQN.fit(tS, Qtarget, verbose=False)
