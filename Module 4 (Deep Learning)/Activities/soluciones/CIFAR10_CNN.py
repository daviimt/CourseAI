...
CLASES= ['Avion', 'automóvil', 'pájaro', 'gato', 'ciervo', 'perro', 'rana', 
...
# Paso 3: Las salidas son valores categóricos (números enteros). 
# Hay que pasarlos a codificación OneHot
...
# OJO: Se espera que el accuracy en test sea muy inferior al del training. La red sobreentrena con la 
#      configuración básica establecida.
